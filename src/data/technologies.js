export const technologies = [
  {
    ...
    items: [
      { id: "react", name: "React.js", description: "Modern, reactive web UI library with rich ecosystem." },
      { id: "angular", name: "Angular", description: "Enterprise-scale TypeScript framework by Google." },
      { id: "vue", name: "Vue.js", description: "Progressive, lightweight, and easy-to-learn framework." }
    ]
  },
  {
    category: "backend",
    ...
    items: [
      { id: "dotnet", name: ".NET (C#)", description: "Microsoft's fast, secure enterprise server framework." },
      { id: "nodejs", name: "Node.js (Express/NestJS)", description: "JavaScript backend offering massive scalability." },
      { id: "java", name: "Java (Spring Boot)", description: "Heavyweight, robust server development standard." },
      { id: "python", name: "Python (Django/FastAPI)", description: "Best for AI, machine learning, and rapid development." },
      { id: "php", name: "PHP (Laravel)", description: "Highly popular, modern web framework with fast deployment." },
      { id: "go", name: "Go (Golang)", description: "Google's concurrent, ultra-efficient compiled language." }
    ]
  },
  {
    category: "mobile",
    ...
    items: [
      { id: "flutter", name: "Flutter (Dart)", description: "Cross-platform mobile apps with native speed." },
      { id: "react_native", name: "React Native", description: "Write mobile apps in React, rendering native views." },
      { id: "ios_native", name: "iOS Native (Swift)", description: "Pure iOS performance and Apple ecosystem integrations." },
      { id: "android_native", name: "Android Native (Kotlin)", description: "Standard Android development with full device capabilities." }
    ]
  },
  {
    category: "database",
